...
\begin{tikzpicture}[
  all/.style = {fill plain picture = {
    \draw[cfixed, line width = 1.3cm] ( 0,-1) -- (2,1);
    \draw[cbox,   line width = 1.3cm] (-2,-1) -- (0,1);
    \draw[cflow,  line width = 1.0cm] (-1,-1) -- (1,1);
  }},
  box/.style = {fill = cbox},
...
\end{verbatim}
  ...
  \node[blank, anchor = north, align = flush center] (bargraph1) at ([yshift = \vsep]padding.south) {};
\end{tikzpicture}